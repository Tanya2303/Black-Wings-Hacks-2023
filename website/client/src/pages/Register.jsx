...
//                 <form className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-[60rem] overflow-hidden h-[35rem]">
...
//                                             <input type="password" className="w-full -ml-10 pl-2 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-secondary" placeholder="password" />
//                                         </div>
//                                     </div>
//                                 </div>
//                                 <div className="flex -mx-3">
